...
baseline_potential_AgAgCl =0.35; %in AgAgCl
...
iR=24.5;%input R obtain in EIS, put 0 if no need iR correct.
iR_compen=0.85; %input iR compensation percentage
smoothing_weight=100;
WL_max=920;
WL_min=520;
filename1='NiOOH3SEC'; %SEC data
filename2='WL'; % WL file from Solis
filename3='NiOOH3_JV'; % JC from SEC
...
JV_iR=[potential_iR+RHE_conv_factor,current(iR_correct_region)];
%Plot data
